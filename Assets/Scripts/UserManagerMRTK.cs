...
namespace CompasXR.Database.FirebaseManagment
{
    ...
    */
    ...
    public class UserManagerMRTK : MonoBehaviour
    {
        /*
        ...
        */
        ...
        public Dialog SelectTeamDialog;
        public Dialog SelectMemberDialog;

        private string selectedTeam = "TeamA";
        private string selectedMember = "MemberA";
        ...
        private void SetPrimaryUIItemsOnStart()
        {
            ...
            */
            ...
            //Find Primary UI Objects  
            SelectMemberDialog.gameObject.SetActive(false);
            SelectTeamDialog.gameObject.SetActive(true);  

            SelectTeamDialog.SetPositive("Team A", args =>
            {
                selectedTeam = "TeamA";
                SelectMemberDialog.gameObject.SetActive(true);
            }).SetNegative("Team B", args =>
            {
                selectedTeam = "TeamB";
                SelectMemberDialog.gameObject.SetActive(true);
            });

            SelectMemberDialog.SetPositive("MemberA", args =>
            {
                selectedMember = "MemberA";
                Debug.Log($"Selected Team: {selectedTeam}, Selected Member: {selectedMember}");
                CreateUser();
            }).SetNegative("Member B", args =>
            {
                selectedMember = "MemberB";
                Debug.Log($"Selected Team: {selectedTeam}, Selected Member: {selectedMember}");
                CreateUser();
            });
        }
        ...
        public void CreateUser()
        {
            ...
            Username = selectedTeam + "/" + selectedMember;
            ...
            string playerName = Username.ToLower();
            ...
            dbReference_root.Child("Users").Child(playerName).GetValueAsync().ContinueWithOnMainThread(task =>
            {
                ...
                {   
                    if (snapshot.Child("devices").Child(userID).Exists)
                    {
                        ...
                        dbReference_root.Child("Users").Child(playerName).Child("devices").Child(userID).Child("dates").SetValueAsync(currentDates).ContinueWithOnMainThread(t =>
                        {
                            ...
                            {
                                Debug.Log($"User {playerName} updated successfully.");
                    ...
                    {   
                        dbReference_root.Child("Users").Child(playerName).Child("devices").Child(userID).Child("dates").Child("0").SetValueAsync(time).ContinueWithOnMainThread(t =>
                        {
                            ...
                            {
                                Debug.Log($"Device {userID} created successfully.");
                ...
                {   
                    ...
                    dbReference_root.Child("Users").Child(playerName).SetRawJsonValueAsync(json).ContinueWithOnMainThread(t =>
                    {
                        ...
                        {
                            Debug.Log($"User {playerName} created successfully.");
                            StaticData.User = playerName;
                            // HelpersExtensions.ChangeScene("HumanSupervision");
                            HelpersExtensions.ChangeScene("MainGame");
                        }
